...
$(document).ready(function(){
    setTimeout(function(){
        $('.notification_wrapper_alert, .notification_wrapper_notice').fadeOut("slow", function() {
            $(this).remove();
        });
    }, 2500);
});
